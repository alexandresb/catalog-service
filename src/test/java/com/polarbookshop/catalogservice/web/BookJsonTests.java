...
public class BookJsonTests {
    ...
    void testSerialize() throws IOException {
        ...
        assertThat(jsonContent).extractingJsonPathStringValue("@.createdBy").isEqualTo("jenny");
        assertThat(jsonContent).extractingJsonPathStringValue("@.lastModifiedBy").isEqualTo("eline");
    ...
    void testDeserialize() throws IOException {
       ...
       //fonctionnalité bloc de texte
        var content= """
                ...
                """;
        assertThat(json.parse(content)).usingRecursiveComparison().isEqualTo(new Book(394L,"1234567890", "Title", "Author", 9.90,"Polarsophia",instant,instant, "jenny", "eline",21));
    }
}
