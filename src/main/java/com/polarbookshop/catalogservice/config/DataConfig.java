...
/* activation de l'audit des données lors de leur l'insertion, modification ou suppression d'enregistrement en base
...
Ces métadonnées seront intégrées dans les requêtes (cas d'insert ou upadate) au niveau des champs de l'enregistrement correspondant
